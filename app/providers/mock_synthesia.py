...
class MockSynthesiaProvider(VideoProvider):

    def list_avatars(self) -> list[dict]:
        return [{"id": "syn_avatar_014", "name": "James Okafor"}]

    def estimate_cost(self, brief: VideoBrief) -> float:
        rate_per_second = 0.065
    ...
    def create_video(self, brief: VideoBrief) -> dict:
        ...
        return {
            ...
            "provider": "synthesia",
            "status": "queued",
            "estimated_completion_seconds": random.randint(40, 100),
        }
